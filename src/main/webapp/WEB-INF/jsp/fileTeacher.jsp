  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="upload_form" action="${APP_PATH}/uploadFile" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            <label for="recipient-name" class="control-label">文件名:</label>
            <!-- 上传需要改造 -->
            <input type="file" name="uploadfile">
            <input type="hidden" name="fTName" id="fTName">
          </div>
           <div class="modal-footer">
       			 <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
        		<button type="button" class="btn btn-primary" id="upload_add_btn">上传</button>
      </div>
        </form>
      </div>
	...
	<div>
	 ...
	 <button class="btn btn-danger" id="upload_add" data-toggle="modal" data-target="#uploadModal" data-whatever="@mdo">上传文件</button>
	 </div>
	</div>
	</div>
		<!-- 表格 -->
	...
	<script type="text/javascript">
		...
		$('#upload_add_btn').click(function(){
			var hideForm = $('#upload_form');
			var options = {
				dataType:"json",
				data:{'uploadfile':$('input[type=file]').val(),'name':$('input[type=hidden]').val()},
